...
alias senv=". set_env.sh"
alias sync_int='gsutil -m rsync -r -u gs://enso-test-data-staging/integrations/ ~/integrations/'
#
# Package managers and virtual environement creation
...
alias up_stage='git checkout staging && git pull && git checkout -'
